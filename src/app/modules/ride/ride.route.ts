...
router.get("/history", checkAuth(UserRole.RIDER, UserRole.DRIVER), RideController.viewRideHistroy);
...
router.get("/myActiveRide", checkAuth(UserRole.RIDER, UserRole.DRIVER), RideController.getMyActiveRide)
